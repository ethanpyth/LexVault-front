export default function KPI({ status, nbc, nbp }: Readonly<{ nbp: string, nbc: string, status: string}>) {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-12 pt-10 border-outline-variant/50">
      <div className="flex flex-col gap-1 p-6 rounded-2xl bg-surface-low border border-outline-variant/20 hover:shadow-md transition-all">
        ...
        <div className="flex items-baseline gap-2">
          <span className="text-4xl font-bold text-on-surface font-headline-md tracking-tight">{ nbc }</span>
      ...
      <div className="flex flex-col gap-1 p-6 rounded-2xl bg-surface-low border border-outline-variant/20 hover:shadow-md transition-all">
        ...
        <div className="flex items-baseline gap-2">
          <span className="text-4xl font-bold text-on-surface font-headline-md tracking-tight">{ nbp }</span>
      ...
      <div className="flex flex-col gap-1 p-6 rounded-2xl bg-[#fff7ed] border-l-4 border-l-[#f97316]/20 hover:shadow-md transition-all">
        ...
        <div className="flex items-center gap-3">
          <span className="text-3xl font-bold text-[#f97316] font-headline-m">{ status }</span>
