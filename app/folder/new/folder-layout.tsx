  ...
  return (
    <div>
      ...
      <div className="grow flex flex-col md:flex-row max-w-container-max mx-auto w-full relative">
        ...
        <main className={
          stepLabel === "identity"
            ? "flex-1 ml-0 md:ml-80 pb-20"
            : stepLabel === "representation"
              ? "grow lg:ml-80 pt-16 px-gutter pb-stack-lg"
              : stepLabel === "attachments"
                ? "flex-1 md:ml-80 bg-background p-margin-mobile md:p-margin-desktop overflow-hidden"
                : stepLabel === "payments"
                  ? "flex-1 lg:ml-80 pb-20"
